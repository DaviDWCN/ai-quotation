...
async def wecom_callback(
    ...
    message_data = mq_payload.get("data")
    if isinstance(message_data, (WeComTextMessage, WeComImageMessage, WeComFileMessage)):
        mq_payload["data"] = message_data.model_dump()  # type: ignore[assignment]
